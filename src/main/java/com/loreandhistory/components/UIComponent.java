...
import com.loreandhistory.events.ComponentEventListener;
import com.loreandhistory.interfaces.MenuAction;
...
public abstract class UIComponent
{
    ...
    public void setActionName(int index, String label) {
        this.widget.setAction(index, label);
    }
